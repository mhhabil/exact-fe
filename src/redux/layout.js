...
const initialMenuCollapsed = () => {
  const item = (typeof window !== 'undefined') ? window.localStorage.getItem('menuCollapsed') : undefined;
  //** Parse stored json or if none return initialValue
  return item ? JSON.parse(item) : themeConfig.layout.menu.isCollapsed;
}

const initialDirection = () => {
  const item = (typeof window !== 'undefined') ? window.localStorage.getItem('direction') : undefined;
  //** Parse stored json or if none return initialValue
  return item ? JSON.parse(item) : themeConfig.layout.isRTL;
}

const initialSkin = () => {
  const item = (typeof window !== 'undefined') ? window.localStorage.getItem('skin') : undefined;
  //** Parse stored json or if none return initialValue
