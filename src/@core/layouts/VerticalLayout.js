...
import { fetchPatientDetail } from '@src/shared/header/stores/patient-detail.store';
  ...
  return (
    <Fragment>
      ...
      <div
        ...
        )} ${userData && userData.isNurse && (patientDetail && (!patientDetail.Alergi || !patientDetail.Pengkajian_Keperawatan)) ? 'disabled-div' : ''}`}
