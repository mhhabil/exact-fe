...
const HeadImageModal = (props: { isOpen: boolean, onClose: any, title: string, onImageSubmit: any, image: any, formName: string, component: string }) => {
  ...
  const handleReset = () => {
    ...
    setPic('/assets/default/head.jpg');
  }
