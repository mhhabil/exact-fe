...
import { PhacoImageService } from '../services';
...
const PhacoImageModal = (props: { isOpen: boolean, onClose: any, title: string, onImageSubmit: any, image: any, formName: string, component: string }) => {
  ...
  const handleReset = () => {
    ...
    setPic('/assets/default/phaco-clean.jpg');
  }
...
export default PhacoImageModal;
