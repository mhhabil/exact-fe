...
const GridChart = (props: { initialData: any, anesthesiaScale: string, onSavedData: any, onSavedImage: any, onSavedScale: any, component: string, formName: string }) => {
  ...
  useEffect(() => {
    if (anesthesiaScale && anesthesiaScale === '1') {
      setScale(1);
    }
    ...
    if (label && label.length === 0 && anesthesiaScale) {
      if (anesthesiaScale === '1') {
        setLabel(Array.from({ length: sisVal.length }, (_, i) => (i + 1) * 1))
      }
      if (anesthesiaScale === '5') {
        setLabel(Array.from({ length: sisVal.length }, (_, i) => (i + 1) * 5))
      }
      if (anesthesiaScale === '10') {
        setLabel(Array.from({ length: sisVal.length }, (_, i) => (i + 10) * 10))
      }
      if (anesthesiaScale === '15') {
        setLabel(Array.from({ length: sisVal.length }, (_, i) => (i + 15) * 15))
      }
      if (anesthesiaScale === '20') {
        setLabel(Array.from({ length: sisVal.length }, (_, i) => (i + 20) * 20))
      }
    }
  }, [anesthesiaScale])
  ...
  useEffect(() => {
    if (scale && scale === 1) {
      if (label && label.length > 0 && label[0] !== 1) {
        setLabel(Array.from({ length: label.length }, (_, i) => (i + 1) * 1))
      }
      setMinTime(1);
      setMaxTime(30);
      setSteps(1);
    ...
    if (scale && scale === 5) {
      if (label && label.length > 0 && label[0] !== 5) {
        setLabel(Array.from({ length: label.length }, (_, i) => (i + 1) * 5))
      }
      setMinTime(5);
      setMaxTime(150);
      setSteps(5);
    ...
    if (scale && scale === 10) {
      if (label && label.length > 0 && label[0] !== 10) {
        setLabel(Array.from({ length: label.length }, (_, i) => (i + 1) * 10))
      }
      setMinTime(10);
      setMaxTime(300);
      setSteps(10);
    ...
    if (scale && scale === 15) {
      if (label && label.length > 0 && label[0] !== 15) {
        setLabel(Array.from({ length: label.length }, (_, i) => (i + 1) * 15))
      }
      setMinTime(15);
      setMaxTime(450);
      setSteps(15);
    ...
    if (scale && scale === 20) {
      if (label && label.length > 0 && label[0] !== 20) {
        setLabel(Array.from({ length: label.length }, (_, i) => (i + 1) * 20))
      }
      setMinTime(20);
      setMaxTime(600);
      setSteps(20);
  ...
  const setChart = (val: any) => {
    if (label && label.length === 0) {
      ...
      if (minTime === 1) {
        setLabel([...label, label[label.length - 1] + 1])
      }
      if (minTime === 5) {
