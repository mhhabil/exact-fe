...
const AnestesiImageModal = (props: { isOpen: boolean, onClose: any, title: string, onImageSubmit: any, image: any, formName: string, component: string }) => {
  ...
  const handleReset = () => {
    ...
    setPic('/assets/default/Image_2.png');
  }
  ...
  return (
    <Modal isOpen={isOpen} className="modal-dialog modal-fullscreen">
      ...
      <ModalBody>
        <Row>
          <Col sm="12" md="12"  className="overflow-hidden panel order-sm-1 order-md-0">
          ...
          <Col sm="12" md="12" xxl="12" className="order-sm-0 order-md-1" onClick={handleClickOutside}>
...
export default AnestesiImageModal;
