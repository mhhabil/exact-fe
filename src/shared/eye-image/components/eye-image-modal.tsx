...
import ChecklistImage from './checklist-image';
import Compressor from 'compressorjs';
import { EyeImageService } from '../services';
import { IconButton } from '@src/shared/button';
import StarImage from './star-image';
import { UploadToCloudService } from '@src/shared/upload-cloud-storage/services';
import { useAppSelector } from '@hooks/useAppSelector';

const EyeImageModal = (props: { isOpen: boolean, onClose: any, title: string, onImageSubmit: any, image: any, formName: string, component: string }) => {
  ...
  const handleReset = () => {
    ...
    setPic('/assets/default/eye-clean.jpg');
  }
