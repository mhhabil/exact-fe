...
import IntegratedEducationPharmacyForm from '@src/modules/pharmacy/integrated-education-pharmacy/components/integrated-education-pharmacy-form';

const EdukasiTerintegrasiFarmasi = () => {
            ...
            <Col sm="12" md="12" xxl="12" className="mb-1">
              {/* <IntegratedEducationNutritionForm /> */}
              {
                integratedEducation && integratedEducation.EMR_ID === treatment?.EMR_ID && (
                  <IntegratedEducationPharmacyForm data={integratedEducation}/>
                )
              }
            </Col>
          </Row>
...
export default EdukasiTerintegrasiFarmasi;
