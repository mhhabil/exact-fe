      ...
      <Card>
        ...
        <CardBody>
          ...
          <Row>
            <Col className="mb-1">
              {
                doctorPreliminaryStudy && doctorPreliminaryStudy.EMR_ID === treatment?.EMR_ID && (
                  <CpptOkForm doctorPreliminaryStudy={doctorPreliminaryStudy}/>
                )
              }
            </Col>
            {
