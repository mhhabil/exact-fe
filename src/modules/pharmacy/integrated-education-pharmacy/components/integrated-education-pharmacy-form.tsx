...
import { IUpdateIntegratedEducationRequest, UpdateIntegratedEducationRequest } from "@src/modules/inpatient/integrated-education/requests";
import { IntegratedEducationService } from "@src/modules/inpatient/integrated-education/services";
...
import InputIntegratedEducationPharmacy from "./input-integrated-education-pharmacy";
import { PdfIntegratedEducationRequest } from "@src/modules/inpatient/integrated-education/requests/pdf-integrated-education-request";
import { DateTimeConverter } from '@src/shared/datetime-converter';
// import InputIntegratedEducationNutrition from "./input-integrated-education-nutrition";

const IntegratedEducationPharmacyForm = (props: { data: IntegratedEducationModel}) => {
  const { data } = props;
  ...
  const handleDoctorSigned = (image: SignatureModel) => {
    setValue('ttd_edukator_farmasi', image.Signature);
    setValue('id_edukator_farmasi', image.ID_Karyawan);
  }
  ...
  const handlePatientSigned = (image: string) => {
    setValue('ttd_penerima_edukasi_farmasi', image);
  }
    ...
    <>
      <Form onSubmit={handleSubmit(handleSubmitForm)}>
        <FormGroup className="form-group" row>
          <InputIntegratedEducationPharmacy
            data={data}
          ...
          <FormGroup>
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_penggunaan_obat"
                  type="checkbox"
                  name="farmasi_penggunaan_obat"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Farmasi?.Penggunaan_Obat === 1}
                  innerRef={register("farmasi_penggunaan_obat") as any}
                />{' '}
                <Label>Penggunaan Obat Yang Efektif dan Aman</Label>
              </Col>
            </Row>
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_efek_samping"
                  type="checkbox"
                  name="farmasi_efek_samping"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Farmasi?.Efek_Samping === 1}
                  innerRef={register("farmasi_efek_samping") as any}
                />{' '}
                <Label>Efek Samping Dan Penanganannya</Label>
              </Col>
            </Row>
            <Row>
              <Col md='3' className="mt-1"></Col>
              <Col className="mt-1">
                <Input
                  id="farmasi_mencegah_interaksi"
                  type="checkbox"
                  name="farmasi_mencegah_interaksi"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Farmasi?.Mencegah_Interaksi === 1}
                  innerRef={register("farmasi_mencegah_interaksi") as any}
                />{' '}
                <Label>Mencegah Interaksi Antar Obat Dengan Obat Dan Atau Makanan</Label>
              </Col>
            </Row>
            <Row>
              <Col md='3' className="mt-1"></Col>
              <Col className="mt-1">
                <Input
                  id="farmasi_lain_lain"
                  type="checkbox"
                  name="farmasi_lain_lain"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Farmasi?.Lain_Lain === 1}
            ...
            <Row>
              ...
              <Col className="mt-2">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Diskusi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_demonstrasi"
                  type="checkbox"
                  name="farmasi_demonstrasi"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Demonstrasi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Ceramah === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Solusi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_observatori"
                  type="checkbox"
                  name="farmasi_observatori"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Observatori === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_metode_pembelajaran_lain"
                  type="checkbox"
                  name="farmasi_metode_pembelajaran_lain"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Metode_Pembelajaran?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id="farmasi_metode_pembelajaran_lain_teks"
                  type="text"
                  className="mt-1"
            ...
            <Row className="mt-2">
              ...
              <Col>
                <Input
                  id="farmasi_mampu_mengerti"
                  type="checkbox"
                  name="farmasi_mampu_mengerti"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Evaluasi_Pasien?.Mampu_Mengerti === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_mampu_memahami"
                  type="checkbox"
                  name="farmasi_mampu_memahami"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Evaluasi_Pasien?.Mampu_Memahami === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="farmasi_evaluasi_pasien_lain"
                  type="checkbox"
                  name="farmasi_evaluasi_pasien_lain"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Evaluasi_Pasien?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id="farmasi_evaluasi_pasien_lain_teks"
                  type="text"
                  className="mt-1"
            ...
            <Row className="mt-2">
              ...
              <Col>
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Penerima_Edukasi?.Pasien === 1}
              ...
              <Col md='3'>
                <Input
                  ...
                  defaultChecked={data?.form?.Farmasi?.Penerima_Edukasi?.Pasangan === 1}
              ...
              <Col>
                <Input
                  id='farmasi_orang_tua'
                  type='checkbox'
                  name='farmasi_orang_tua'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Penerima_Edukasi?.Orang_Tua === 1}
              ...
              <Col>
                <Input
                  id='farmasi_saudara_kandung'
                  type='checkbox'
                  name='farmasi_saudara_kandung'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Penerima_Edukasi?.Saudara_Kandung === 1}
            ...
            <Row className='mt-1'>
              ...
              <Col>
                <Input
                  id='farmasi_penerima_edukasi_lain'
                  type='checkbox'
                  name='farmasi_penerima_edukasi_lain'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Farmasi?.Penerima_Edukasi?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id='farmasi_penerima_edukasi_lain_teks'
                  type='text'
              ...
              <Col>
                <div className="mt-2 d-flex justify-content-around my-0">
                  <Signature
                    ...
                    initialImage={(data && data.form && data.form.TTD_Penerima_Edukasi_Farmasi && data.form.TTD_Penerima_Edukasi_Farmasi !== '') ? data.form.TTD_Penerima_Edukasi_Farmasi : undefined}
                    onSigned={(image: string) => handlePatientSigned(image)} />
                  <Input
                    type="hidden"
                    name="ttd_penerima_edukasi_farmasi"
                    innerRef={register()}
                    invalid={errors.ttd_penerima_edukasi_farmasi && true} />
                </div>
              </Col>
              <Col>
                <div className="mt-2 d-flex justify-content-around my-0">
                  <Signature
                    label="Edukator"
                    type="picker"
                    additionalLabel={(data && data.form && data.form.Nama_Edukator_Farmasi) ? data.form.Nama_Edukator_Farmasi : ''}
                    initialImage={(data && data.form && data.form.TTD_Edukator_Farmasi && data.form.TTD_Edukator_Farmasi !== '') ? data.form.TTD_Edukator_Farmasi : undefined}
                    persons={officers}
                  ...
                  <Input
                    ...
                    innerRef={register()}
                    invalid={errors.ttd_edukator_farmasi && true}
                  />
                  <Input
                    type="hidden"
                    name="id_edukator_farmasi"
                    innerRef={register()}
                    invalid={errors.id_edukator_farmasi && true}
                  />
                </div>
              </Col>
            </Row>
...
export default IntegratedEducationPharmacyForm;
