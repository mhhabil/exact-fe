...
import cyl from '../consts/cyl';

const CylSelector = (props: { name: string, disabled?:boolean, register: any, errors: any, setValue: any, getValues: any, label?: string, required?: boolean }) => {

  const { name, disabled, register, errors, setValue, getValues, label = 'Cyl', required = true } = props;
  ...
  return (
    <Fragment>
      <Label for={name} sm="12">Cyl</Label>
      <Col>
        <Input
          id={name}
          name={name}
