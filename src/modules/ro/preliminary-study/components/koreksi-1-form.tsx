...
const Koreksi1Form = (props: { register: any, errors: any, setValue: any, getValues: any, type: string, defaultChecked?: boolean, watch?: any }) => {
          ...
          showForm && (
            <Fragment>
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SphSelector name={`${type}_koreksi_1_sph`} label={`Sph Koreksi-1 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} />
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <CylSelector name={`${type}_koreksi_1_cyl`} label={`Cyl Koreksi-1 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} />
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <AxisSelector name={`${type}_koreksi_1_axis`} label={`Axis Koreksi-1 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} />
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_va`} label="Visus Akhir" {...{ register, errors }}>
              ...
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_false`} label="False" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_add`} label="Add" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_jagger`} label="Jagger" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_pd_jauh`} label="PD Jauh" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
              ...
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_pd_dekat`} label="PD Dekat" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="6" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput name={`${type}_koreksi_1_adaptasi`} label="Adaptasi" {...{ register, errors }}>
                      <option value="" disabled={false}>--</option>
