...
export interface ICreateCpptInpatientNurseRequest extends IAppRequest {
  id_berobat: string;
  unit: string;
  data_s: string;
...
export class CreateCpptInpatientNurseRequest extends AppRequest {
  id_berobat: string;
  unit: string;
  data_s: string;
  data_s_lain_text: string;
  ...
  constructor(request: ICreateCpptInpatientNurseRequest) {
    super(request);
  ...
  static createFromJson(json: ICreateCpptInpatientNurseRequest) {
    return new CreateCpptInpatientNurseRequest(json);
  }
}
