...
const AssessmentVitalSignsFormDetail = (props: { item?: AssessmentVitalSignsItemModel | undefined, onSuccessSubmit: any, unit: string }) => {
        ...
        .then(() => {
          AssessmentVitalSignsService().show(appRequest)
            .then((resp) => {
              ...
              const params = PdfAssessmentVitalSignsRequest.createPdfRequest(data, appRequest.emr_id);
...
export default AssessmentVitalSignsFormDetail;
