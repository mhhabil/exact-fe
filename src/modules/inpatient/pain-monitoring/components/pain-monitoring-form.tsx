...
const PainMonitoringFormDetail = (props: { item?: PainMonitoringItemModel | undefined, onSuccessSubmit: any, unit: string }) => {
        ...
        .then(() => {
          PainMonitoringService().show(appRequest)
            .then((resp) => {
              ...
              const params = PdfPainMonitoringRequest.createPdfRequest({ ...data, umur_lengkap: treatment?.Pasien?.Umur_Lengkap }, appRequest.emr_id);
...
export default PainMonitoringFormDetail;
