...
const RetinaLaserActionReportFormDetail = (props: { data: any, item?: any | undefined }) => {
  ...
  const handleSubmitForm = (value: ICreateRetinaLaserActionReportRequest) => {
    ...
    //             ToolInspectionService().pdfv3(PdfRetinaLaserActionRequest.createPdfRequest({ ...data, nomor_mr: appRequest.nomor_mr, umur_lengkap: treatment?.Pasien?.Umur_Lengkap }, appRequest.emr_id))
    //               .then((res) => {
    //                 const { data } = res.data;
  ...
  return (
    <Form onSubmit={handleSubmit(handleSubmitForm)}>
      <h4 className="mt-1">Hasil Tindakan Laser</h4>
      <DicomForm
        dicom={data.dicoms} modality={"US"}
      />
      <h4 className="mt-2">Form Hasil Tindakan Laser Retina</h4>
        ...
        <Row>
          <Col>
            <div className='d-flex'>
              <Label style={{marginLeft:'30px'}}>Retina OD : </Label>
              <Image src={data.Gambar_Retina_OD && data.Gambar_Retina_OD !== '' ? data.Gambar_Retina_OD : '/assets/default/retina-right.jpg'} alt='' width='150rem' height='150rem'/>
            </div>
          </Col>
          <Col>
            <div className='d-flex'>
              <Label>Retina OS : </Label>
              <Image src={data.Gambar_Retina_OS && data.Gambar_Retina_OS !== '' ? data.Gambar_Retina_OS : '/assets/default/retina-left.jpg'} alt='' width='150rem' height='150rem'/>
            </div>
          </Col>
        </Row>
      </FormGroup>
...
export default RetinaLaserActionReportFormDetail;
