...
import { IPediatric, IPrescription, Image, IImage } from '../../doctor-preliminary-study/models/doctor-preliminary-study.model';
import { IPictureDataO, PictureDataO } from '../requests/create-cppt-out-patient.request';
export interface ICpptOutPatientModel {
  EMR_ID: string;
  ID: string;
  Data_A: string
  Unit: string;
...
export class CpptOutPatientModel {
  EMR_ID: string;
  ID: string;
  Data_A: string
  Data_A_Lain_Text: string
  ...
  constructor(cpptRo: ICpptOutPatientModel) {
