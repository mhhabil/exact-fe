...
export interface ICreateCpptOutPatientNurseRequest extends IAppRequest {
  unit: string;
  data_s: string;
...
export class CreateCpptOutPatientNurseRequest extends AppRequest {
  unit: string;
  data_s: string;
  data_s_lain_text: string;
  data_o: string;
  ...
  constructor(request: ICreateCpptOutPatientNurseRequest) {
    super(request);
  ...
  static createFromJson(json: ICreateCpptOutPatientNurseRequest) {
    return new CreateCpptOutPatientNurseRequest(json);
  }
}
