...
export class PupilOCTResultForm {
  ...
  constructor(pupil: IPupilOCTResultForm) {
    ...
    this.TTD_Dokter_Pemeriksa = pupil.TTD_Dokter_Pemeriksa;
    this.Dokter_Pemeriksa_Nama = pupil.Dokter_Pemeriksa_Nama;
    this.Dokter_Pemeriksa_Id = pupil.Dokter_Pemeriksa_Id;
    this.TTD_Perawat_Pemeriksa = pupil.TTD_Perawat_Pemeriksa;
    this.Perawat_Pemeriksa_Nama = pupil.Perawat_Pemeriksa_Nama;
    this.Perawat_Pemeriksa_Id = pupil.Perawat_Pemeriksa_Id;
    this.Kesimpulan_Opt = pupil.Kesimpulan_Opt;
