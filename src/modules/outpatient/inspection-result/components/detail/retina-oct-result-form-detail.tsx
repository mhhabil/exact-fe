...
const RetinaOctResultFormDetail = (props: { data: any, item?: any | undefined }) => {
  const kesimpulan = [
    'ODS DBN',
    'Lain-lain',
  ];
  ...
  return (
    <Form onSubmit={handleSubmit(handleSubmitForm)}>
      ...
      />
      <h4 className="mt-2">Form Hasil Pemeriksaan Alat Oct Retina</h4>
...
export default RetinaOctResultFormDetail;
