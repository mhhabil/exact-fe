...
import {PdfPupilOctResultRequest} from '@modules/outpatient/inspection-result/requests/pdf-pupil-oct-result.request';
import DicomForm from '../../components/form/dicom-form';
import { DateTimeConverter } from '@src/shared/datetime-converter';

const PupilOCTResultForm = (props: { data: any, dicom?: any | undefined, onSuccessSubmit: any, onCancel: any }) => {
  ...
  return (
    <Form onSubmit={handleSubmit(handleSubmitForm)}>
      ...
      <FormGroup  className="d-flex justify-content-center" style={{ marginLeft: '130px'}}>
