...
import { PdfOctCorneaResultsRequest } from '../../requests/pdf-oct-cornea-results';
import DicomForm from '../../components/form/dicom-form';
import { DateTimeConverter } from '@src/shared/datetime-converter';

const OctCorneaResults = (props: { data: any, dicom?: any | undefined, onSuccessSubmit: any, onCancel: any }) => {
  ...
  const { register, handleSubmit, errors, setValue, getValues, control } = useForm({
    ...
    defaultValues: {
      ...
      ketebalan_od: data && data.Ketebalan_OD ? data.Ketebalan_OD : '',
      ketebalan_os: data && data.Ketebalan_OS ? data.Ketebalan_OS : '',
  ...
  const handleSubmitForm = (value: ICreateOctCorneaResultsRequest) => {
    ...
    if (!data) {
      const params = CreateOctCorneaResultsRequest.createFromJson({...value, ...appRequest, unit });
          ...
          if (response && response.data && response.data.data) {
            ...
            ToolInspectionService().view(params2)
              .then((resp) => {
                ...
                ToolInspectionService().pdfv3(PdfOctCorneaResultsRequest.createPdfRequest({ ...data, nomor_mr: appRequest.nomor_mr, umur_lengkap: treatment?.Pasien?.Umur_Lengkap }, appRequest.emr_id))
                  .then((res) => {
                    const { data } = res.data;
      ...
      const params = UpdateOctCorneaResultsRequest.createFromJson({...value, ...appRequest, ID: data.ID, unit, emr_id: data.EMR_ID });
            ...
            <Row>
              ...
              <Col md='9'>
                <Input
                  ...
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  defaultChecked={data && data.OD_Irregular_Epitel_Check === '1'}
                  value='1'
            ...
            <Row>
              ...
              <Col md='9'>
                <Input
                  ...
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  defaultChecked={data && data.OD_Irreguler_Endotel_Check === '1'}
                  value='1'
            ...
            <Row>
              ...
              <Col md='5' style={{marginLeft:'58px'}}>
                <Input
                  ...
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  defaultChecked={data && data.OD_Anterior_Chamber_Check === '1'}
                  value='1'
      ...
      <FormGroup className='form-group' row>
        <Row className='mt-1'>
          <Col md='6' sm='12'>
            <Row>
              <Col>
                <Label className='ms-2' style={{width:'100%'}}>AC / Angle:</Label>
              </Col>
              <Col md='5' style={{marginLeft:'58px'}}>
                <Input
          ...
          <Col md='6' sm='12'>
            ...
            <Row className='mt-1'>
              ...
              <Col md='4'style={{marginLeft:'26px'}}>
                <Input
                  id='od_lens_thickness_check'
                  type='checkbox'
                  name='od_lens_thickness_check'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  defaultChecked={data && data.OD_Lens_Thickness_Check === '1'}
                  value='1'
                  innerRef={register('od_lens_thickness_check') as any}
                />
                <Label>Lens Thickness :</Label>
              </Col>
              <Col>
                <Input
                  id='od_lens_thickness'
                  type='text'
                  name='od_lens_thickness'
