...
import VisualFieldResultFormDetail from './detail/visual-field-test-results-form-detail';
import RetinaOctResultForm from './form/retina-oct-result-form';
import RetinaOctResultFormDetail from './detail/retina-oct-result-form-detail';
import PupilOCTResultFormDetail from './detail/pupil-oct-result-form-detail';
import ResultUsgFormDetail from './detail/result-usg-form-detail';
import ReportYagLaserFormDetail from '../../inspection-result-yag-laser-and-retina/components/report-yag-laser-form-detail';
import RetinaLaserActionReportFormDetail from '../../inspection-result-yag-laser-and-retina/components/retina-laser-action-report-form-detail';
import BiometricExamDetail from './detail/biometric-exam-detail';
import FundusPhotoExaminationDetail from './detail/fundus-photo-examination-detail';
import OctCorneaResultsDetail from './detail/oct-cornea-results-detail';
import CheckSchimerTestDetail from './detail/check-schimer_test_detail';
import { DateTimeConverter } from '@src/shared/datetime-converter';

const InspectionResultTable = (props: { data: ToolInspectionModel }) => {
  ...
  const handleDeleteRow = (row: any) => {
    ...
    ToolInspectionService().delete(params).then(() => {
      const appRequest = AppRequest.createFromStore(treatment);
      dispatch(fetchInspectionResult(appRequest));
  ...
  return (
    <Fragment>
          ...
          <Table responsive>
            <thead>
              <tr className="fw-bolder">
                ...
                <td className="text-center">Jenis Pemeriksaan</td>
      ...
      <Modal isOpen={!!detailRow} size="xl">
        ...
        <ModalBody>
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Biometri' && (
              <BiometricExamDetail data={detailRow}  />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Lapangan_Pandang' && (
              <VisualFieldResultFormDetail data={detailRow} />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Oct_Retina' && (
              <RetinaOctResultFormDetail data={detailRow} />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Oct_Glaukoma' && (
              <PupilOCTResultFormDetail data={detailRow} />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Usg' && (
              <ResultUsgFormDetail data={detailRow} />
            )
          }
          {/* {
          ...
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Foto_Fundus' && (
              <FundusPhotoExaminationDetail data={detailRow} />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Pemeriksaan_Oct_Cornea' && (
              <OctCorneaResultsDetail data={detailRow} />
            )
          }
          {
            detailRow && detailRow.Nama && detailRow.Nama === 'Laporan_Hasil_Schirmer_Test' && (
              <CheckSchimerTestDetail data={detailRow} />
            )
          }
        </ModalBody>
      </Modal>
