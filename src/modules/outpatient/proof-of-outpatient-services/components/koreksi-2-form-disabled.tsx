...
const Koreksi2FormDisabled = (props: { register: any, errors: any, setValue: any, getValues: any, type: string, defaultChecked?: boolean, watch?: any }) => {
          ...
          showForm && (
            <Fragment>
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SphSelector disabled name={`${type}_koreksi_2_sph`} label={`Sph Koreksi-2 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} required={false}/>
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <CylSelector disabled name={`${type}_koreksi_2_cyl`} label={`Cyl Koreksi-2 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} required={false}/>
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <AxisSelector disabled name={`${type}_koreksi_2_axis`} label={`Axis Koreksi-2 ${type.toUpperCase()}`} {...{ register, errors, setValue, getValues }} required={false}/>
                  </FormGroup>
                </Col>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_va`} label="Visus Akhir" {...{ register, errors }} required={false}>
              ...
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_false`} label="False" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_add`} label="Add" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_jagger`} label="Jagger" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_pd_jauh`} label="PD Jauh" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
              ...
              <Row>
                <Col md="3" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_pd_dekat`} label="PD Dekat" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
                ...
                <Col md="6" sm="12">
                  <FormGroup className="form-group">
                    <SelectInput disabled name={`${type}_koreksi_2_adaptasi`} label="Adaptasi" {...{ register, errors }} required={false}>
                      <option value="" disabled={false}>--</option>
...
export default Koreksi2FormDisabled;
