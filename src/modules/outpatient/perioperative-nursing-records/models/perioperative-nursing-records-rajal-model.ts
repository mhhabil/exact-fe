...
export interface IPerioperativeNursingRecordsRajalFormModel {
    Bb: string;
    Rr: string;
    Tb: string;
    Td: string;
...
export class PerioperativeNursingRecordsRajalFormModel {
    Bb: string;
    Rr: string;
    Tb: string;
    Td: string;
    ...
    constructor(request: IPerioperativeNursingRecordsRajalFormModel) {
      this.Bb = request.Bb;
      this.Rr = request.Rr;
      this.Tb = request.Tb;
      this.Td = request.Td;
...
export interface IPerioperativeNursingRecordsRajalModel extends IDataModel {
    form:  IPerioperativeNursingRecordsRajalFormModel;
    ok: IPerioperativeNursingRecordsFormModel;
    cppt: any;
    asesmen: IAssessmentUgdFormModel;
    ews: INursingEarlyWarning;
}

export class PerioperativeNursingRecordRajalsModel extends DataModel {
    form:  IPerioperativeNursingRecordsRajalFormModel;
    ok: IPerioperativeNursingRecordsFormModel;
    cppt: any;
    asesmen: IAssessmentUgdFormModel;
    ...
    constructor(peri: IPerioperativeNursingRecordsRajalModel) {
      super(peri);
      this.form = peri.form;
      this.ok = peri.ok;
      this.cppt = peri.cppt;
      this.asesmen = peri.asesmen;
      this.ews = peri.ews;
    }
}
