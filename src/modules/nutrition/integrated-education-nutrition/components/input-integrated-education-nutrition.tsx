...
const InputIntegratedEducationNutrition = (props: { data: IntegratedEducationModel, setValue:any, initialImage?: string, register: any, errors: any }) => {
...
export default InputIntegratedEducationNutrition;
