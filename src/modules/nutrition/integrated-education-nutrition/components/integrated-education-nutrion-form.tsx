...
const IntegratedEducationNutritionForm = (props: { data: IntegratedEducationModel}) => {
  const { data } = props;
  ...
  const handleDoctorSigned = (image: SignatureModel) => {
    setValue('ttd_edukator_gizi', image.Signature);
    setValue('id_edukator_gizi', image.ID_Karyawan);
  }

  const handlePatientSigned = (image: string) => {
    setValue('ttd_penerima_edukasi_gizi', image);
  }
    ...
    <>
      <Form onSubmit={handleSubmit(handleSubmitForm)}>
        <FormGroup className="form-group" row>
          <InputIntegratedEducationNutrition
            data={data}
          ...
          <FormGroup>
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Gizi?.Status_Gizi === 1}
                  innerRef={register("gizi_status_gizi") as any}
                />{' '}
                <Label>Status Gizi Dan Menjelaskan Makanan</Label>
              </Col>
            </Row>
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="gizi_selama_perawatan"
                  type="checkbox"
                  name="gizi_selama_perawatan"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Gizi?.Selama_Perawatan === 1}
                  innerRef={register("gizi_selama_perawatan") as any}
                />{' '}
                <Label>Diet Selama Perawatan</Label>
              </Col>
            </Row>
            <Row>
              <Col md='3' className="mt-1"></Col>
              <Col className="mt-1">
                <Input
                  id="gizi_untuk_dirumah"
                  type="checkbox"
                  name="gizi_untuk_dirumah"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Gizi?.Untuk_Dirumah === 1}
                  innerRef={register("gizi_untuk_dirumah") as any}
                />{' '}
                <Label>Diet Untuk DiRumah</Label>
              </Col>
            </Row>
            <Row>
              <Col md='3' className="mt-1"></Col>
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Gizi?.Diluar_RS === 1}
                  innerRef={register("gizi_diluar_rs") as any}
                />{' '}
                <Label>Diet DiLuar RS</Label>
              </Col>
            </Row>
            {/* <Row>
              <Col md='3' className="mt-1"></Col>
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value="1"
                  defaultChecked={data?.form?.Materi_Edukasi_Penjelasan?.Gizi?.Lain_Lain === 1}
            ...
            <Row>
              ...
              <Col className="mt-2">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Diskusi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Demonstrasi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Ceramah === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Solusi === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Observatori === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="gizi_metode_pembelajaran_lain"
                  type="checkbox"
                  name="gizi_metode_pembelajaran_lain"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Metode_Pembelajaran?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id="gizi_metode_pembelajaran_lain_teks"
                  type="text"
                  className="mt-1"
            ...
            <Row className="mt-2">
              ...
              <Col>
                <Input
                  id="gizi_mampu_mengerti"
                  type="checkbox"
                  name="gizi_mampu_mengerti"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Evaluasi_Pasien?.Mampu_Mengerti === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="gizi_mampu_memahami"
                  type="checkbox"
                  name="gizi_mampu_memahami"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Evaluasi_Pasien?.Mampu_Memahami === 1}
            ...
            <Row>
              ...
              <Col className="mt-1">
                <Input
                  id="gizi_evaluasi_pasien_lain"
                  type="checkbox"
                  name="gizi_evaluasi_pasien_lain"
                  className="me-1"
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Evaluasi_Pasien?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id="gizi_evaluasi_pasien_lain_teks"
                  type="text"
                  className="mt-1"
            ...
            <Row className="mt-2">
              ...
              <Col>
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Penerima_Edukasi?.Pasien === 1}
              ...
              <Col md='3'>
                <Input
                  ...
                  defaultChecked={data?.form?.Gizi?.Penerima_Edukasi?.Pasangan === 1}
              ...
              <Col>
                <Input
                  ...
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Penerima_Edukasi?.Orang_Tua === 1}
              ...
              <Col>
                <Input
                  id='gizi_saudara_kandung'
                  type='checkbox'
                  name='gizi_saudara_kandung'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Penerima_Edukasi?.Saudara_Kandung === 1}
            ...
            <Row className='mt-1'>
              ...
              <Col>
                <Input
                  id='gizi_penerima_edukasi_lain'
                  type='checkbox'
                  name='gizi_penerima_edukasi_lain'
                  className='me-1'
                  onChange={(e) => handleCheckboxChange(e)}
                  value='1'
                  defaultChecked={data?.form?.Gizi?.Penerima_Edukasi?.Lain === 1}
              ...
              <Col md='7'>
                <Input
                  id='gizi_penerima_edukasi_lain_teks'
                  type='text'
              ...
              <Col>
                <div className="mt-2 d-flex justify-content-around my-0">
                  <Signature
                    ...
                    initialImage={(data && data.form && data.form.TTD_Penerima_Edukasi_Gizi && data.form.TTD_Penerima_Edukasi_Gizi !== '') ? data.form.TTD_Penerima_Edukasi_Gizi : undefined}
                    onSigned={(image: string) => handlePatientSigned(image)} />
                  <Input
                    type="hidden"
                    name="ttd_penerima_edukasi_gizi"
                    innerRef={register()}
                    invalid={errors.ttd_penerima_edukasi_gizi && true} />
                </div>
              </Col>
              <Col>
                <div className="mt-2 d-flex justify-content-around my-0">
                  <Signature
                    label="Edukator"
                    type="picker"
                    additionalLabel={(data && data.form && data.form.Nama_Edukator_Gizi) ? data.form.Nama_Edukator_Gizi : ''}
                    initialImage={(data && data.form && data.form.TTD_Edukator_Gizi && data.form.TTD_Edukator_Gizi !== '') ? data.form.TTD_Edukator_Gizi : undefined}
                    persons={officers}
                  ...
                  <Input
                    ...
                    innerRef={register()}
                    invalid={errors.ttd_edukator_gizi && true}
                  />
                  <Input
                    type="hidden"
                    name="id_edukator_gizi"
                    innerRef={register()}
                    invalid={errors.id_edukator_gizi && true}
                  />
                </div>
              </Col>
            </Row>
...
export default IntegratedEducationNutritionForm;
