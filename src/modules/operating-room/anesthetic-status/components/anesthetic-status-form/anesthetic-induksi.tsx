...
const FormAnestheticInduksi = (props: { data: AnestheticStatus,  register: any,  errors: any, processing: boolean, setValue: any}) => {
      ...
      <Card className="border-1">
        <Col md="12" sm="12" style={{paddingTop:'10px', paddingBottom:'10px'}}>
          ...
          <FormGroup className="form-group" row>
            <TextInput name="induksi_intravena" label="Intravena" md={3} {...{ register, errors }}  />
          </FormGroup>
          <FormGroup className="form-group" row>
            <TextInput name="induksi_inhalasi" label="Inhalasi" md={3} {...{ register, errors }}  />
          </FormGroup>
        </Col>
...
export default FormAnestheticInduksi;
