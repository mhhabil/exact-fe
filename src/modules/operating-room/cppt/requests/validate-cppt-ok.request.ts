...
export interface IValidateCpptOkRequest extends IValidateCpptRoRequest {
  ID: string;
  dokter_dpjp: string;
}

export class ValidateCpptOkRequest extends ValidateCpptRoRequest {
  ID: string;
  dokter_dpjp: string;

  constructor(request: IValidateCpptOkRequest) {
    super(request);
    this.ID = request.ID;
  ...
  static createFromJson(json: IValidateCpptOkRequest) {
    return new ValidateCpptOkRequest(json);
  }
}
