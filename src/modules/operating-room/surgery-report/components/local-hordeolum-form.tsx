...
import localChalazionTop from '@modules/operating-room/surgery-report/const/local-chalazion/localChalazionTop';

const LocalHordeolumForm = (props: { mainRegister: any, mainErrors: any, mainSetValue: any, mainGetValues: any, defaultSelected?: boolean, data: any, processing: boolean, pdfData: any, publicRuntimeConfig: any }) => {
          ...
          <tr>
            <td style={{ width: '50%', textAlign: 'center' }}>
              <EyeImage
                ...
                formName='ok/laporan-pembedahan'
                component='laporan_pembedahan_lokal_hordeolum_pra'
            ...
            <td style={{ width: '50%', textAlign: 'center' }}>
              <EyeImage
                ...
                formName='ok/laporan-pembedahan'
                component='laporan_pembedahan_lokal_hordeolum_pasca'
...
export default LocalHordeolumForm;
