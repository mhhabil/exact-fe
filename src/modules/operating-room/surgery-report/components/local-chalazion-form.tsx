...
const LocalChalazionForm = (props: { mainRegister: any, mainErrors: any, mainSetValue: any, mainGetValues: any, defaultSelected?: boolean, data: any, processing: boolean, pdfData: any, publicRuntimeConfig: any }) => {
  ...
  const [checkboxLocalChalazionBot, setCheckboxLocalChalazionBot] = useState(localChalazionBot.map((i: any, key: number) => {
    return {
      id: i.id,
      name: i.text,
  ...
  const [checkboxLocalChalazionDiteteskan, setCheckboxLocalChalazionDiteteskan] = useState(localChalazionDrip.map((i: any, key: number) => {
    return {
      id: i.id,
      name: i.text,
  ...
  useEffect(() => {
    if (data && data.form) {
      ...
      setCheckboxLocalChalazionBot(localChalazionBot.map((i: any, key: number) => {
        return {
          id: i.id,
          name: i.text,
          checked: (data && data.form) ? data.form[`Lokal_Chalazion_${i.id}`] : false,
      ...
      setCheckboxLocalChalazionDiteteskan(localChalazionDrip.map((i: any, key: number) => {
        return {
          id: i.id,
          name: i.text,
          checked: (data && data.form) ? data.form[`Lokal_Chalazion_Diteteskan_${i.id}`] : false,
  ...
  const handleSelectAll = (e: any) => {
    ...
    const newValue3 = checkboxLocalChalazionDiteteskan.map(c => {
      const a = {...c};
      a.checked = e.target.checked;
      return a;
    });
    checkboxLocalChalazionDiteteskan.forEach(item => {
      mainSetValue(`lokal-chalazion-diteteskan-${item.id}`, e.target.checked ? '1' : '0');
    });
    setCheckboxLocalChalazionDiteteskan(newValue3);
    ...
    <TabContent activeTab={activeTab}>
                        ...
                        <><Row>
                          <Col>
                            <Input
                              ...
                              className="me-1 mt-1"
                              value="1"
                              defaultChecked={data.form.Anestesi_Infiltrasi_Tipe === '1'}
                              onChange={(e) => handleRadioChange(e)}
                        ...
                        <Row>
                          <Col>
                            <Input
                              ...
                              className="me-1 mt-1"
                              value="2"
                              defaultChecked={data.form.Anestesi_Infiltrasi_Tipe === '2'}
                              onChange={(e) => handleRadioChange(e)}
                              innerRef={mainRegister("anestesi-infiltrasi-tipe")}/>{' '}
                        ...
                        <><Row>
                          <Col>
                            <Input
                              ...
                              className="me-1 mt-1"
                              value="1"
                              defaultChecked={data.form.Anestesi_Field_Block_Tipe === '1'}
                              onChange={(e) => handleRadioChange(e)}
                        ...
                        <Row>
                          <Col>
                            <Input
                              ...
                              className="me-1 mt-1"
                              value="2"
                              defaultChecked={data.form.Anestesi_Field_Block_Tipe === '2'}
                              onChange={(e) => handleRadioChange(e)}
                              innerRef={mainRegister("anestesi-field-block-tipe")}/>{' '}
      ...
      <TabPane tabId='2'>
              ...
              <Row key={item.id} className="mt-1">
                <Col>
                  <Input
                    ...
                    className='me-1'
                    // defaultChecked={!!(data && data.form && data.form[`Lokal_Chalazion_${item.id}`])}
        ...
        <Row className="mt-1 mb-1">
          <Col>
            <Input
              ...
              className='me-1'
              // defaultChecked={!!(data && data.form && data.form.Lokal_Chalazion_3)}
              checked={checkboxLocalChalazion3 === '1'}
              innerRef={mainRegister(`lokal-chalazion-3`)}
              onChange={(e) => {
                handleCheckboxChange(e);
                setCheckboxLocalChalazion3(e.target.value ? '1' : '0');
              }}
            />
        ...
        <Row className="mt-2">
          ...
          <Col>
            {
              checkboxLocalChalazionDiteteskan && checkboxLocalChalazionDiteteskan.map((item: any, key: number) => (
                <Row key={key} className='mb-1'>
                  <Col>
                    <Input
                      type="checkbox"
                      ...
                      onChange={(e) => {
                        handleCheckboxChange(e);
                        const index = checkboxLocalChalazionDiteteskan.findIndex(c => c.id === item.id);
                        if (index >= 0) {
                          const newValue = [...checkboxLocalChalazionDiteteskan];
                          newValue[index].checked = e.target.checked;
                          setCheckboxLocalChalazionDiteteskan(newValue);
                        }
                      }}
                    />
                    <label>{item.name}</label>
          ...
          <tr>
            <td style={{ width: '50%', textAlign: 'center' }}>
              <EyeImage
                ...
                formName='ok/laporan-pembedahan'
                component='laporan_pembedahan_lokal_chalazion_pra'
            ...
            <td style={{ width: '50%', textAlign: 'center' }}>
              <EyeImage
                ...
                formName='ok/laporan-pembedahan'
                component='laporan_pembedahan_lokal_chalazion_pasca'
...
export default LocalChalazionForm;
