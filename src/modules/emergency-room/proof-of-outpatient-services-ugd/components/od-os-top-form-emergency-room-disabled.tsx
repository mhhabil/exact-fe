...
const OdOsTopFormEmergencyRoomDisabled = (props: { register: any, errors: any, type: string }) => {
    ...
    <Row>
      <Col md="12">
        <Row>
          <Col md="4" sm="12">
            <FormGroup className="form-group">
              <SelectInput name={`${type}_va`} label="Visual Aquity" {...{ register, errors }} required={false}>
          ...
          <Col md="4" sm="12">
            <FormGroup className="form-group">
              <SelectInput name={`${type}_false`} label="False" {...{ register, errors }} required={false}>
                <option value="" disabled={false}>--</option>
                {
          ...
          <Col md="4" sm="12">
            <FormGroup className="form-group">
              <SelectInput name={`${type}_ph`} label="PH" {...{ register, errors }} required={false}>
                <option value="" disabled={false}>--</option>
                {
                  ph && ph.map((p, key) => {
        ...
        <Row>
          <Col md="4" sm="12">
            <FormGroup className="form-group">
              <SelectInput name={`${type}_add`} label="Add" {...{ register, errors }} required={false}>
                <option value="" disabled={false}>--</option>
                {
          ...
          <Col md="4" sm="12">
            <FormGroup className="form-group">
              <SelectInput name={`${type}_jagger`} label="Jagger" {...{ register, errors }} required={false}>
                <option value="" disabled={false}>--</option>
                {
...
export default OdOsTopFormEmergencyRoomDisabled;
