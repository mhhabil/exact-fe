...
const OdOsBottomFormEmergencyRoomDisabled = (props: { register: any, errors: any, type: string }) => {
    ...
    <Row>
      <Col md="12">
        ...
        <Row>
          ...
          <Col md="6" sm="12">
            <FormGroup className="form-group" style={{marginTop: '-12px'}}>
              <SelectInput name={`${type}_tanam_lensa`} label="Keterangan Tanam Lensa" {...{ register, errors }} required={false}>
        ...
        <Row>
          ...
          <Col md="6" sm="12">
            <FormGroup className="form-group" style={{marginTop: '-12px'}}>
              <SelectInput name={`${type}_keterangan_tono`} label="Keterangan Tono" {...{ register, errors }} required={false}>
                <option value="">--</option>
                {
...
export default OdOsBottomFormEmergencyRoomDisabled;
