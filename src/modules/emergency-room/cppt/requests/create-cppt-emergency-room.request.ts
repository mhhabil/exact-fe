...
export interface ICreateCpptEmergencyRoomRequest extends ICreateCpptRoRequest {
  anjuran: string
  resep?: any
  unit: string;
...
export class CreateCpptEmergencyRoomRequest extends CreateCpptRoRequest {
  resep?: any
  anjuran: string;
  unit: string;
  gambar_mata_od: string;
  ...
  constructor(request: ICreateCpptEmergencyRoomRequest) {
    super(request);
  ...
  static createFromJson(json: ICreateCpptEmergencyRoomRequest) {
    return new CreateCpptEmergencyRoomRequest(json);
  }
}
